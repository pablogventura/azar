...
def makro(n):
    lista = [0,1,2,6,14,33,76,175,400]
    return lista[n]
...
def jugar_y_ver(cant):
    alnegro(cant)
    esperar_resultado()
    if salio_negro() and numero()%2==0 and numero()!=0:
        #negro par
        return "G"
    elif (salio_negro() or numero()%2==0) and numero()!=0:
        #negro o par exclusivo
        return "E"
    else:
        #rojo e impar
        return "P"
...
def main():
    ...
    while True:
        ...
        if gane == "G":
            ...
            raise ValueError("paso algo raro")
